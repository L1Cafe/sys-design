...
- [Design a Twitter clone](hard/twitter.md)
- [Design a distributed OS](hard/distributed_os.md)
- [Design a hypervisor](hard/hypervisor.md)
- [Design a distributed database](hard/distributed_database.md)

# Specialty

## Cryptocurrency

- [Explain Bitcoin](cryptocurrency/bitcoin.md)
- [Design a zero-trust distributed smart-contracts system](cryptocurrency/zero-trust_distributed_smart-contracts.md)

## Security

- [Explain iptables](security/iptables.md)
- [Design a RAT (Remote-Access Trojan)](security/rat.md)

## Databases and storage

- [Design a filesystem](databases_storage/filesystem.md)
- [Design a multi-paradigm database](databases_storage/multi-paradigm_database.md)
